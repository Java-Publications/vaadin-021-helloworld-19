...
# Backend meets Frontend: The first graphic rewards
Our application should learn to calculate and graphically display the results using the CalcComponent. However, when implementing the four basic arithmetic there are some things to keep in mind, especially in terms of division.
...
* german article [http://bit.ly/jaxenter-019](http://bit.ly/jaxenter-019)
