...
public class MainView extends AbstractBaseCustomComponent {
  ...
  protected Component createComponent() {
    ...
    contentLayout.setId(cssLayoutID().apply(MainView.class, "Content"));

    final VerticalLayout menuLayout = new VerticalLayout();
    menuLayout.setId(verticalLayoutID().apply(MainView.class, "MenuLayout"));
    ...
    mainLayout.setId(horizontalLayoutID().apply(MainView.class, "MainLayout"));
